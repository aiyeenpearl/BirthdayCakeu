document.addEventListener("DOMContentLoaded", function () {
  ...
  let isSongPlaying = false; // Flag to track if the song is playing
  ...
  function isBlowing() {
    ...
    return average > 50; // Threshold for detecting blowing
  }
    ...
    if (
      ...
      if (isBlowing()) {
        ...
        if (!isSongPlaying) {
          ...
          isSongPlaying = true; // Set the flag to true when the song starts playing
        }
